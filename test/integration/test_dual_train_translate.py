...
ENCODER_DECODER_SETTINGS = [
    ...
    ("--unsupervised-training --encoder rnn --num-layers 1 --rnn-cell-type lstm --rnn-num-hidden 16 --num-embed 8 --rnn-attention-type mlp"
    ...
    ("--unsupervised-training --encoder rnn-with-conv-embed --conv-embed-max-filter-width 3 --conv-embed-num-filters 4:4:8"
    ...
    ("--unsupervised-training --encoder transformer --num-layers 2:1 --rnn-cell-type gru --rnn-num-hidden 16 --num-embed 8:16"
    ...
    ("--unsupervised-training --encoder rnn --decoder transformer --num-layers 2:2 --rnn-cell-type lstm --rnn-num-hidden 16 --num-embed 16"
     ...
     False, True, False),
    # Full transformer
    ("--unsupervised-training --encoder transformer --decoder transformer"
    ...
    ("--unsupervised-training --encoder transformer --decoder transformer"
     ...
     True, False, True),
    # 3-layer cnn
    ("--unsupervised-training --encoder cnn --decoder cnn "
...
@pytest.mark.parametrize("train_params, translate_params, restrict_lexicon, use_prepared_data, use_source_factors",
                         ENCODER_DECODER_SETTINGS)
def test_dual_train_translate(train_params: str,
