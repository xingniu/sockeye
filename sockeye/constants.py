...
LANGUAGE_MODEL_PREFIX = 'language_model_'
RECONSTRUCTION_PREFIX = 'reconstruction_'
...
LANGUAGE_MODEL_SOFTMAX_OUTPUT_NAME = LANGUAGE_MODEL_PREFIX + SOFTMAX_OUTPUT_NAME
...
INSTANTIATING_HIDDEN_CHOICES = [ARGMAX_NAME, SOFTMAX_SAMPLE_NAME, SOFTMAX_NAME, ST_SOFTMAX_NAME, GUMBEL_SOFTMAX_NAME,
                                ST_GUMBEL_SOFTMAX_NAME]
