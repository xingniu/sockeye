...
BACKWARD_MODEL_PREFIX = 'backward_'
...
LANGUAGE_MODEL_OUTPUT_NAME = LANGUAGE_MODEL_PREFIX + SOFTMAX_OUTPUT_NAME
BACKWARD_MODEL_OUTPUT_NAME = BACKWARD_MODEL_PREFIX + SOFTMAX_OUTPUT_NAME
