...
RECONSTRUCTION_PREFIX = RECONSTRUCTION + '_'
REFINEMENT = "refinement"
REFINEMENT_PREFIX = REFINEMENT + '_'
HIGHLIGHT = "highlight"
HIGHLIGHT_PREFIX = HIGHLIGHT + '_'
SAMPLING_OBJECTIVES = [RECONSTRUCTION, REFINEMENT, HIGHLIGHT]
...
RECONSTRUCTION_SOFTMAX_OUTPUT_NAME = RECONSTRUCTION_PREFIX + SOFTMAX_OUTPUT_NAME
REFINEMENT_SOFTMAX_OUTPUT_NAME = REFINEMENT_PREFIX + SOFTMAX_OUTPUT_NAME
HIGHLIGHT_SOFTMAX_OUTPUT_NAME = HIGHLIGHT_PREFIX + SOFTMAX_OUTPUT_NAME
