...
class Translator:
    ...
    def _beam_search(self,
        ...
        for t in range(1, max_output_length):
            ...
            scores = self._update_scores.forward(raw_scores, finished, inactive, scores_accumulated, pad_dist)
    ...
    def _get_best_from_beam(self,
        ...
        for n in range(0, self.nbest_size):
            ...
            best_word_indices_for_top_hypotheses = best_word_indices[indices, np.arange(indices.shape[1])]
            ...
            if beam_histories is not None and beam_histories[0] is not None:
                for sent in range(self.batch_size):
                    ...
                    valid_length = sum(np.logical_and(best_word_indices_for_top_hypotheses[sent] != C.PAD_ID,
                                                      best_word_indices_for_top_hypotheses[sent] != self.vocab_target[C.EOS_SYMBOL]))
